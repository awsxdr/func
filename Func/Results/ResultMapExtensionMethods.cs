namespace Func
{
	...
	public static class ResultMapExtensionMethods
	{
		...
		public static Func<TValue2, TValue3, Result<TResult>> ThenMap<TValue1, TValue2, TValue3, TResult>(this Result<TValue1> result, Func<TValue1, TValue2, TValue3, TResult> func) =>
			(value2, value3) => result.Then(value1 => func(value1, value2, value3).Map(Succeed));
		...
		public static Func<TValue2, TValue3, TValue4, Result<TResult>> ThenMap<TValue1, TValue2, TValue3, TValue4, TResult>(this Result<TValue1> result, Func<TValue1, TValue2, TValue3, TValue4, TResult> func) =>
			(value2, value3, value4) => result.Then(value1 => func(value1, value2, value3, value4).Map(Succeed));

		public static Func<TValue3, TValue4, Result<TResult>> ThenMap<TValue1, TValue2, TValue3, TValue4, TResult>(this Result<TValue2> result, Func<TValue1, TValue2, TValue3, TValue4, TResult> func, TValue1 value1) =>
			(value3, value4) => result.Then(value2 => func(value1, value2, value3, value4).Map(Succeed));
		...
		public static Func<TValue2, TValue3, TValue4, TValue5, Result<TResult>> ThenMap<TValue1, TValue2, TValue3, TValue4, TValue5, TResult>(this Result<TValue1> result, Func<TValue1, TValue2, TValue3, TValue4, TValue5, TResult> func) =>
			(value2, value3, value4, value5) => result.Then(value1 => func(value1, value2, value3, value4, value5).Map(Succeed));

		public static Func<TValue3, TValue4, TValue5, Result<TResult>> ThenMap<TValue1, TValue2, TValue3, TValue4, TValue5, TResult>(this Result<TValue2> result, Func<TValue1, TValue2, TValue3, TValue4, TValue5, TResult> func, TValue1 value1) =>
			(value3, value4, value5) => result.Then(value2 => func(value1, value2, value3, value4, value5).Map(Succeed));

		public static Func<TValue4, TValue5, Result<TResult>> ThenMap<TValue1, TValue2, TValue3, TValue4, TValue5, TResult>(this Result<TValue3> result, Func<TValue1, TValue2, TValue3, TValue4, TValue5, TResult> func, TValue1 value1, TValue2 value2) =>
			(value4, value5) => result.Then(value3 => func(value1, value2, value3, value4, value5).Map(Succeed));
		...
		public static Func<TValue2, TValue3, TValue4, TValue5, TValue6, Result<TResult>> ThenMap<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TResult>(this Result<TValue1> result, Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TResult> func) =>
			(value2, value3, value4, value5, value6) => result.Then(value1 => func(value1, value2, value3, value4, value5, value6).Map(Succeed));

		public static Func<TValue3, TValue4, TValue5, TValue6, Result<TResult>> ThenMap<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TResult>(this Result<TValue2> result, Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TResult> func, TValue1 value1) =>
			(value3, value4, value5, value6) => result.Then(value2 => func(value1, value2, value3, value4, value5, value6).Map(Succeed));

		public static Func<TValue4, TValue5, TValue6, Result<TResult>> ThenMap<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TResult>(this Result<TValue3> result, Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TResult> func, TValue1 value1, TValue2 value2) =>
			(value4, value5, value6) => result.Then(value3 => func(value1, value2, value3, value4, value5, value6).Map(Succeed));

		public static Func<TValue5, TValue6, Result<TResult>> ThenMap<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TResult>(this Result<TValue4> result, Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TResult> func, TValue1 value1, TValue2 value2, TValue3 value3) =>
			(value5, value6) => result.Then(value4 => func(value1, value2, value3, value4, value5, value6).Map(Succeed));
